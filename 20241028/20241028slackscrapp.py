...
client = WebClient(token="Put your token!")

def get_active_channels(client, days=30):
    try:
...
active_channels = get_active_channels(client, days=30)
...
for channel in selected_channels:
    ...
    for file in files:
        ...
        download_file(file["url_private"], "YOUR_SLACK_TOKEN", file_path)
    ...
    message_texts = [{"text": msg["text"]} for msg in messages if "text" in msg]
